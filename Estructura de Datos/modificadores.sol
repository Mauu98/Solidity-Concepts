...
contract view_pure_payable{
    ...
    mapping(address=>cartera) DineroCartera; //Nos relaciona la dirección con la cantidad de dinero
    ...
    function Pagar(string memory _nombrePersona, uint _cantidad) public payable{ //memory -> Al terminar la llamada de la función se elimina de la memoria
